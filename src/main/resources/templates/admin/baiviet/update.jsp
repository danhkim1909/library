				...
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<form class="card-body" th:object="${baiViet}" method="post"
							th:action="@{/admin/baiviet/update}" enctype="multipart/form-data">
							<input type="hidden" th:field="*{maBaiViet}">
							<input type="hidden" th:field="*{anhBase64}">
							<div class="row">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<img id="anhPreview" th:src="${baiViet.anhBase64}" alt="Ảnh xem trước"
