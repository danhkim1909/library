			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<form class="card-body" th:object="${sach}" method="post" th:action="@{/admin/sach/create}"
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Tên sách</label> <input type="text" class="form-control"
											th:field="*{tenSach}">
										<div class="text-danger" th:if="${#fields.hasErrors('tenSach')}"
									...
									<div class="form-group">
										<div>
											<label>Thể loại:</label> <select multiple="multiple"
												...
												style="width: 100%;">
												<option th:each="theLoai : ${theLoais}" th:value="${theLoai.maTheLoai}"
													th:text="${theLoai.tenTheLoai}"></option>
											</select>
										</div>
										<div class="text-danger" th:if="${#fields.hasErrors('theLoaiIds')}"
											th:errors="*{theLoaiIds}"></div>
									</div>

									<div class="form-group">
										<div>
											<label>Tác giả:</label> <select multiple="multiple" th:field="*{tacGiaIds}"
												class="form-control select2-multi" style="width: 100%;">
												<option th:each="tacGia : ${tacGias}" th:value="${tacGia.maTacGia}"
													th:text="${tacGia.tenTacGia}">
												</option>
											</select>
										</div>
										<div class="text-danger" th:if="${#fields.hasErrors('tacGiaIds')}"
											th:errors="*{tacGiaIds}"></div>
									</div>
									<div class="form-group">
										<label>Nhà xuất bản</label> <select class="form-control" th:field="*{nxbId}">
											<option value="">-- Chọn nhà xuất bản --</option>
											<option th:each="nxb : ${nxbs}" th:value="${nxb.maNhaXuatBan}"
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Năm xuất bản</label> <input type="number" class="form-control"
											th:field="*{namXuatBan}">
										<div class="text-danger" th:if="${#fields.hasErrors('namXuatBan')}"
									...
									<div class="form-group">
										...
										<div class="text-danger" th:if="${#fields.hasErrors('anhBia')}"
											th:errors="*{anhBia}"></div>
