			...
			<div class="row">
				<div class="col-12 col-md-12 col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<form th:action="@{/admin/nguoidung/create/docgia}" method="post" id="docGiaForm"
								th:object="${userDocGia}">
								...
								<div class="form-group">
									<label>Mật khẩu</label> <input type="password" th:field="*{matKhau}"
										class="form-control">
									<div th:if="${#fields.hasErrors('matKhau')}" class="text-danger"
										th:errors="*{matKhau}"></div>
								</div>

								<div class="form-group">
									<label>Tên độc giả</label> <input type="text" th:field="*{tenDocGia}"
										class="form-control">
									<div th:if="${#fields.hasErrors('tenDocGia')}" class="text-danger"
										th:errors="*{tenDocGia}"></div>
								</div>
								...
								<div class="form-group">
									<label>Lớp</label> <input type="text" th:field="*{lop}" class="form-control">
									<div th:if="${#fields.hasErrors('lop')}" class="text-danger" th:errors="*{lop}">
									</div>
								</div>
