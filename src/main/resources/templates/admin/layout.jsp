...
<head>
	...
	<link rel="stylesheet" th:href="@{/admins/assets/bundles/select2/dist/css/select2.min.css}">
	...
	<link rel='shortcut icon' type='image/x-icon' th:href="@{/admins/assets/img/favicon.ico}" />
</head>
			...
			<nav class="navbar navbar-expand-lg main-navbar sticky">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown"
							class="nav-link nav-link-lg message-toggle"><i data-feather="mail"></i> <span
								class="badge headerBadge1">
								6 </span> </a>
						<div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
							...
							<div class="dropdown-list-content dropdown-list-message">
								<a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img alt="image" th:src="@{/admins/assets/img/users/user-1.png}" class="rounded-circle">
									</span> <span class="dropdown-item-desc"> <span class="message-user">John Deo</span>
										<span class="time messege-text">Please check your mail !!</span> <span
											class="time">2 Min Ago</span>
									</span>
								</a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
										<img alt="image" th:src="@{/admins/assets/img/users/user-2.png}"
										...
										<img alt="image" th:src="@{/admins/assets/img/users/user-5.png}"
											class="rounded-circle">
										...
										<img alt="image" th:src="@{/admins/assets/img/users/user-4.png}"
											class="rounded-circle">
									</span> <span class="dropdown-item-desc"> <span class="message-user">Lina
											Smith</span> <span class="time messege-text">hii John, I have upload doc
											related to task.</span> <span class="time">30 Min Ago</span>
									</span>
								</a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
										<img alt="image" th:src="@{/admins/assets/img/users/user-3.png}"
											class="rounded-circle">
									</span> <span class="dropdown-item-desc"> <span class="message-user">Jalpa
											Joshi</span> <span class="time messege-text">Please do as specify. Let me
						...
						<div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
							...
							<div class="dropdown-list-content dropdown-list-icons">
								<a href="#" class="dropdown-item dropdown-item-unread"> <span
										...
										moved task <b>Fix bug header</b> to <b>Done</b> <span class="time">12 Hours
											Ago</span>
									</span>
								</a> <a href="#" class="dropdown-item"> <span
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
							class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
								th:src="@{/admins/assets/img/user.png}" class="user-img-radious-style"> <span
						...
						<div class="dropdown-menu dropdown-menu-right pullDown">
							...
							<a href="profile.html" class="dropdown-item has-icon"> <i class="far
								...
								Activities
							</a> <a href="#" class="dropdown-item has-icon"> <i class="fas fa-cog"></i> Settings
							</a>
			...
			<div class="main-sidebar sidebar-style-2">
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand">
						<a th:href="@{/}"> <img alt="image" th:src="@{/admins/assets/img/logo.png}"
								class="header-logo" /> <span class="logo-name">Thư viện 3D</span>
						</a>
					</div>
					<ul class="sidebar-menu">
						<li class="menu-header">Main</li>
						<li class="dropdown active"><a th:href="@{/admin}" class="nav-link"><i
									data-feather="monitor"></i><span>Bảng
									điều khiển</span></a></li>

						<li class="dropdown"><a th:href="@{/admin/nguoidung}" class="nav-link"><i
				...
				<div class="settingSidebar">
					...
					<div class="settingSidebar-body ps-container ps-theme-default">
						<div class=" fade show active">
							...
							<div class="p-15 border-bottom">
								<div class="theme-setting-options">
									<label class="m-b-0"> <input type="checkbox" name="custom-switch-checkbox"
							...
							<div class="p-15 border-bottom">
								<div class="theme-setting-options">
									<label class="m-b-0"> <input type="checkbox" name="custom-switch-checkbox"
											class="custom-switch-input" id="sticky_header_setting"> <span
											class="custom-switch-indicator"></span> <span
