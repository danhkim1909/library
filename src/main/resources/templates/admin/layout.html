...
<meta
	...
	name="viewport">
<title layout:title-pattern="$LAYOUT_TITLE - $CONTENT_TITLE">Library</title>

<link rel="stylesheet"
	th:href="@{/admins/assets/bundles/select2/dist/css/select2.min.css}">
...
<link rel='shortcut icon' type='image/x-icon'
	th:href="@{/admins/assets/img/favicon.ico}" />
</head>
...
<body>
				...
				<ul class="navbar-nav navbar-right">
							...
							<div class="dropdown-list-content dropdown-list-message">
								<a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar
											text-white"> <img
										alt="image" th:src="@{/admins/assets/img/users/user-1.png}"
										class="rounded-circle">
								</span> <span class="dropdown-item-desc"> <span
										class="message-user">John Deo</span> <span
										class="time messege-text">Please check your mail !!</span> <span
										class="time">2 Min Ago</span>
								</span>
								</a> <a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar text-white"> <img
										alt="image" th:src="@{/admins/assets/img/users/user-2.png}"
										class="rounded-circle">
								</span> <span class="dropdown-item-desc"> <span
										class="message-user">Sarah Smith</span> <span
										class="time messege-text">Request for leave application</span>
										<span class="time">5 Min Ago</span>
								</span>
								</a> <a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar text-white"> <img
										alt="image" th:src="@{/admins/assets/img/users/user-5.png}"
										class="rounded-circle">
								</span> <span class="dropdown-item-desc"> <span
										class="message-user">Jacob Ryan</span> <span
										class="time messege-text">Your payment invoice is
											generated.</span> <span class="time">12 Min Ago</span>
								</span>
								</a> <a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar text-white"> <img
										alt="image" th:src="@{/admins/assets/img/users/user-4.png}"
										class="rounded-circle">
								</span> <span class="dropdown-item-desc"> <span
										class="message-user">Lina Smith</span> <span
										class="time messege-text">hii John, I have upload doc
											related to task.</span> <span class="time">30 Min Ago</span>
								</span>
								</a> <a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar text-white"> <img
										alt="image" th:src="@{/admins/assets/img/users/user-3.png}"
										class="rounded-circle">
								</span> <span class="dropdown-item-desc"> <span
										class="message-user">Jalpa Joshi</span> <span
										class="time messege-text">Please do as specify. Let me
											know if you have any query.</span> <span class="time">1 Days
											Ago</span>
								</span>
								</a> <a href="#" class="dropdown-item"> <span
									class="dropdown-item-avatar text-white"> <img
							...
							<div class="dropdown-list-content dropdown-list-icons">
								<a href="#" class="dropdown-item dropdown-item-unread"> <span
									...
									class="dropdown-item-icon bg-info text-white"> <i
										class="fas
												fa-bell"></i>
								</span> <span class="dropdown-item-desc"> Welcome to 3D Library
					...
					<li class="dropdown"><a href="#" data-toggle="dropdown"
						class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img
							alt="image" th:src="@{/admins/assets/img/user.png}"
			...
			<div class="main-sidebar sidebar-style-2">
				<aside id="sidebar-wrapper">
					<div class="sidebar-brand">
						<a th:href="@{/}"> <img alt="image"
							th:src="@{/admins/assets/img/logo.png}" class="header-logo" /> <span
							class="logo-name">Thư viện 3D</span>
						</a>
					</div>
					<ul class="sidebar-menu">
						<li class="menu-header">Main</li>
						<li class="dropdown active"><a th:href="@{/admin}"
							class="nav-link"><i data-feather="monitor"></i><span>Bảng
									điều khiển</span></a></li>

						<li class="dropdown"><a th:href="@{/admin/nguoidung}"
							class="nav-link"><i data-feather="users"></i><span>Quản
									lý người dùng</span></a></li>
						<li class="dropdown"><a th:href="@{/admin/theloai}"
							class="nav-link"><i data-feather="align-center"></i><span>Quản
									lý thể loại</span></a></li>
						<li class="dropdown"><a th:href="@{/admin/tacgia}"
							class="nav-link"><i data-feather="user"></i><span>Quản
									lý tác giả</span></a></li>
						<li class="dropdown"><a th:href="@{/admin/nhaxuatban}"
							class="nav-link"><i data-feather="map-pin"></i><span>Quản
									lý nhà xuất bản</span></a></li>
						<li class="dropdown"><a th:href="@{/admin/sach}"
							class="nav-link"><i data-feather="book"></i><span>Quản
									lý sách</span></a></li>
						<li class="dropdown"><a th:href="@{/admin/kho}"
							class="nav-link"><i data-feather="archive"></i><span>Quản
									lý nhập xuất kho</span></a></li>
							<li class="dropdown"><a th:href="@{/admin/muonsach}"
							class="nav-link"><i data-feather="archive"></i><span>Quản
									lý mượn sách</span></a></li>
											<li class="dropdown"><a th:href="@{/admin/trasach}"
							class="nav-link"><i data-feather="archive"></i><span>Quản
	...
	<script th:src="@{/admins/assets/js/app.min.js}"></script>
	<script th:src="@{/admins/assets/bundles/apexcharts/apexcharts.min.js}"></script>
	<script th:src="@{/admins/assets/js/page/index.js}"></script>
	<script th:src="@{/admins/assets/js/scripts.js}"></script>
	<script type="text/javascript"
		th:src="@{/admins/assets/bundles/select2/dist/js/select2.full.min.js}"></script>
